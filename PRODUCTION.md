...
| `top` | `{"items": [{"t": "…", "href": "…", "img": "…", "by": "…", "avatar": "…", "date": "…"}, …]}` | «أبرز الأخبار» في now (بيملى الصفوف الموجودة بالترتيب) |
...
- الهيرو: `[data-sh-hero]` أكورديون بخمس لوحات `a[data-sh-hero-panel]` بعرض الصفحة كله (مفيش عمود جانبي). اللوحة المفتوحة وقت التحميل هي اللي عليها `sh-index-hero__a-2` (flex-grow 1)، والباقي مقفولة، و`app.js::hero` بياخد شكل المفتوحة والمقفولة من الماركب نفسه؛ أي لوحة جديدة لازم يكون ليها نفس الأبناء بنفس الترتيب (صورة، ستارة، عمود رأسي، شارة المصدر، الكابشن). العدّاد نص ثابت `0N / 05`. تحت 900px أول لوحة كارت والباقي صفوف.
